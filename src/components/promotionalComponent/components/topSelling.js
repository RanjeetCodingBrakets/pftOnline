...
const TopSelling = ({ offerMockData }) => {
  ...
  return (
    <div className='mb-50'>
      <div className="container">
        <div className="row p-4 offer-container top-selling">
          <div className="col-8">
            <h3>Top Selling</h3>
        ...
        <div className="row product-promo-grid promoGrid-topSelling position-relative">
          ...
          {itemsToShow < offerMockData.length && (
            <button onClick={handleShowMore} className="position-absolute showMore-btn topSelling-showbtn">
