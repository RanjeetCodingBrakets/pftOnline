  ...
  return (
    <div className='mb-30'>
      <div className="container">
        <div className="row p-3 offer-container">
          <div className="col-6">
            <h3>Sonderangebot</h3>
        ...
        <div className="row product-promo-grid position-relative">
          {offerMockData.slice(0, itemsToShow).map((product) => (
            <div className="col-6 col-sm-6 col-md-4 col-lg-3 mb-3 product-offer-xss" key={product.id}>
          ...
          {itemsToShow < offerMockData.length && (
            <button onClick={handleShowMore} className="position-absolute showMore-btn">
